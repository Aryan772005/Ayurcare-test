...
export default function FloatingWhatsAppButton() {
  ...
  return (
    ...
    >
      {/* Tooltip bubble above the round button */}
      <a
        href={WA_URL}
        target="_blank"
        ...
        style={{
          ...
          alignItems: 'center',
          gap: '10px',
          boxShadow: '0 8px 32px rgba(0,0,0,0.4), 0 0 0 1px rgba(37,211,102,0.1)',
          cursor: 'pointer',
          userSelect: 'none',
      ...
      >
        ...
        <button
          ...
          onMouseLeave={(e) => ((e.currentTarget as HTMLElement).style.color = 'rgba(37,211,102,0.5)')}
          title="Dismiss"
        >
          <X size={13} />
        </button>
